...
import { U as User, A as Account, S as Session, V as Verification, a as OAuthProvider } from './types-DGbY_2Am.cjs';
...
import { SocialProviders, SocialProviderList } from './social.cjs';
...
interface BetterAuthOptions {
    ...
    user?: {
        ...
        changeEmail?: {
             ...
             */
            sendChangeEmailVerification?: (user: User, newEmail: string, url: string, token: string) => Promise<void>;
        };
    };
    session?: {
        /**

...
var magicLink = (options) => {
  return {
    id: "magic-link",
    endpoints: {
      signInMagicLink: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/sign-in/magic-link",
        {
          method: "POST",
          requireHeaders: true,
      ...
      magicLinkVerify: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/magic-link/verify",
        {
          method: "GET",
          query: zod.z.object({
          ...
          use: [chunkCQNPMJJ3_cjs.originCheck((ctx) => ctx.query.callbackURL)],
          requireHeaders: true,
          metadata: {
            openapi: {

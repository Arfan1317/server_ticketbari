import { P as ProviderOptions, O as OAuth2Tokens } from './types-DGbY_2Am.cjs';
...
export { type AppleOptions, type AppleProfile, type DiscordOptions, type DiscordProfile, type DropboxOptions, type DropboxProfile, type FacebookOptions, type FacebookProfile, type GithubOptions, type GithubProfile, type GoogleOptions, type GoogleProfile, type LinkedInOptions, type LinkedInProfile, type MicrosoftEntraIDProfile, type MicrosoftOptions, type SocialProviderList, type SocialProviders, type SpotifyOptions, type SpotifyProfile, type TwitchOptions, type TwitchProfile, type TwitterOption, type TwitterProfile, apple, discord, dropbox, facebook, github, google, linkedin, microsoft, socialProviderList, socialProviders, spotify, twitch, twitter };

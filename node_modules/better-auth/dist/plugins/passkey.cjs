...
var chunk5YNENWFU_cjs = require('../chunk-5YNENWFU.cjs');
var chunkCQNPMJJ3_cjs = require('../chunk-CQNPMJJ3.cjs');
require('../chunk-NU4SXYJ5.cjs');
require('../chunk-V6RGXSG4.cjs');
require('../chunk-PDRYCYE7.cjs');
require('../chunk-XAK7GFTD.cjs');
...
var passkey = (options) => {
  ...
  return {
    id: "passkey",
    endpoints: {
      generatePasskeyRegistrationOptions: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/passkey/generate-register-options",
        {
          method: "GET",
          use: [chunkCQNPMJJ3_cjs.freshSessionMiddleware],
          metadata: {
            client: false,
            openapi: {
      ...
      generatePasskeyAuthenticationOptions: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      verifyPasskeyRegistration: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      verifyPasskeyAuthentication: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      listPasskeys: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      deletePasskey: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      updatePasskey: chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
Object.defineProperty(exports, "getPasskeyActions", {
  enumerable: true,
  get: function () { return chunk5YNENWFU_cjs.getPasskeyActions; }
});
Object.defineProperty(exports, "passkeyClient", {
  enumerable: true,
  get: function () { return chunk5YNENWFU_cjs.passkeyClient; }
});

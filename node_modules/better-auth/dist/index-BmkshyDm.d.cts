...
import { U as User, S as Session, O as OAuth2Tokens } from './types-DGbY_2Am.cjs';
...
import { H as HookEndpointContext, p as AuthContext } from './auth-DQUo7qHe.cjs';
...
declare const organization: <O extends OrganizationOptions>(options?: O) => {
    ...
    endpoints: {
        ...
        setActiveOrganization: {
            <C extends [better_call.Context<"/organization/activate", {
                method: "POST";
                body: ZodObject<{
        ...
        getFullOrganization: {
            <C extends [better_call.Context<"/organization/get-full", {
                method: "GET";
                query: ZodObject<{
                    orgId: ZodOptional<z.ZodString>;
                }, "strip", z.ZodTypeAny, {
...
declare const twoFactor: (options?: TwoFactorOptions) => {
    ...
    endpoints: {
        ...
        viewBackupCodes: {
            <C extends [(better_call.Context<"/view/backup-codes", {
                method: "GET";
                use: better_call.Endpoint<better_call.Handler<string, better_call.EndpointOptions, {
                    session: {
                        session: {
...
declare const anonymous: (options?: AnonymousOptions) => {
    ...
    endpoints: {
        ...
        linkAccount: {
            <C extends [better_call.Context<"/anonymous/link-account", {
                method: "POST";
                body: z.ZodObject<{
                    email: z.ZodOptional<z.ZodString>;
                    password: z.ZodString;
...
declare const adminMiddleware: better_call.Endpoint<better_call.Handler<string, better_call.EndpointOptions, {
    session: {
        user: UserWithRole;
        session: {
            id: string;
            ...
            <C extends [better_call.Context<"/admin/list-users", {
                ...
                query: z.ZodObject<{
                    search: z.ZodOptional<z.ZodObject<{
                        field: z.ZodEnum<["email", "name"]>;
                        operator: z.ZodDefault<z.ZodEnum<["contains", "starts_with", "ends_with"]>>;
                        value: z.ZodString;
                    }, "strip", z.ZodTypeAny, {
                        value: string;
                        field: "email" | "name";
                        ...
                        value: string;
                        field: "email" | "name";
                        operator?: "contains" | "starts_with" | "ends_with" | undefined;
                    }>>;
                    ...
                    filter: z.ZodOptional<z.ZodArray<z.ZodObject<{
                        ...
                        operator: z.ZodEnum<["eq", "ne", "lt", "lte", "gt", "gte"]>;
                        connector: z.ZodOptional<z.ZodEnum<["AND", "OR"]>>;
                    }, "strip", z.ZodTypeAny, {
    ...
    hooks: {
        after: {
            ...
            handler(ctx: HookEndpointContext<{
                returned: better_call.EndpointResponse;
            }>): Promise<void>;
        }[];
    };
};

export { type AnonymousOptions as A, type Invitation as I, type Member as M, type OrganizationOptions as O, type PasskeyOptions as P, type UserWithPhoneNumber as U, twoFactorClient as a, type Passkey as b, passkeyClient as c, phoneNumber as d, anonymous as e, type UserWithRole as f, getPasskeyActions as g, adminMiddleware as h, admin as i, genericOAuth as j, multiSession as k, emailOTP as l, magicLink as m, type Organization as n, organization as o, passkey as p, twoFactor as t, username as u };

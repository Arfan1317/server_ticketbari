...
async function generator(ctx, options) {
  ...
  for (const plugin of options.plugins || []) {
    ...
    const pluginEndpoints = chunkCQNPMJJ3_cjs.getEndpoints(ctx, {
      ...options,
      plugins: [plugin]
    });
...
var openAPI = (options) => {
  ...
  return {
    id: "open-api",
    endpoints: {
      generateOpenAPISchema: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      openAPIReference: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        path,
        {
          method: "GET",
          metadata: {

...
var emailOTP = (options) => {
  ...
  return {
    id: "email-otp",
    endpoints: {
      sendVerificationOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      createVerificationOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      getVerificationOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      verifyEmailOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      signInEmailOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/sign-in/email-otp",
        {
          method: "POST",
          body: zod.z.object({
      ...
      forgetPasswordEmailOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      resetPasswordEmailOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      after: [
        {
          ...
          async handler(ctx) {
            ...
            if (response instanceof chunkCQNPMJJ3_cjs.APIError) {
              return;
            }

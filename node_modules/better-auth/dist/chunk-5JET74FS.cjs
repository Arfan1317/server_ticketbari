...
var orgMiddleware = chunkCQNPMJJ3_cjs.createAuthMiddleware(async (ctx) => {
  return {};
});
var orgSessionMiddleware = chunkCQNPMJJ3_cjs.createAuthMiddleware(
  {
...
var createInvitation = (option) => chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var acceptInvitation = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var rejectInvitation = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var cancelInvitation = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var getInvitation = chunkCQNPMJJ3_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = await chunkCQNPMJJ3_cjs.getSessionFromCtx(ctx);
    if (!session) {
...
var addMember = () => chunkCQNPMJJ3_cjs.createAuthEndpoint(
  ...
  async (ctx) => {
    const session = ctx.body.userId ? await chunkCQNPMJJ3_cjs.getSessionFromCtx(ctx).catch((e) => null) : null;
    ...
    if (!user) {
      throw new betterCall.APIError("BAD_REQUEST", {
        message: chunkCQNPMJJ3_cjs.BASE_ERROR_CODES.USER_NOT_FOUND
      });
    }
    const alreadyMember = await adapter.findMemberByEmail({
      email: user.email,
...
var removeMember = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var updateMemberRole = (option) => chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var getActiveMember = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var updateOrganization = chunkCQNPMJJ3_cjs.createAuthEndpoint(
  "/organization/update",
  {
    method: "POST",
    body: zod.z.object({
...
var deleteOrganization = chunkCQNPMJJ3_cjs.createAuthEndpoint(
  "/organization/delete",
  {
    method: "POST",
    body: zod.z.object({
...
var getFullOrganization = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var setActiveOrganization = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var listOrganizations = chunkCQNPMJJ3_cjs.createAuthEndpoint(
  "/organization/list",
  {
    method: "GET",
    use: [orgMiddleware, orgSessionMiddleware],
...
var organization = (options) => {
  ...
  const api = shimContext(endpoints, {
    ...
    getSession: async (context) => {
      return await chunkCQNPMJJ3_cjs.getSessionFromCtx(context);
    }
  });
  return {
    id: "organization",
    endpoints: {
      ...api,
      hasPermission: chunkCQNPMJJ3_cjs.createAuthEndpoint(

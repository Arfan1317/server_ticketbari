...
var phoneNumber = (options) => {
  ...
  return {
    id: "phone-number",
    endpoints: {
      signInPhoneNumber: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          if (!session) {
            ...
            throw new betterCall.APIError("UNAUTHORIZED", {
              message: chunkCQNPMJJ3_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_SESSION
            });
          }
      ...
      sendPhoneNumberOTP: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      verifyPhoneNumber: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/phone-number/verify",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
            ...
            if (options?.signUpOnVerification) {
              ...
              if (!user) {
                throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
                  message: chunkCQNPMJJ3_cjs.BASE_ERROR_CODES.FAILED_TO_CREATE_USER
                });
              }
            }
          } else {
          ...
          if (!user) {
            throw new betterCall.APIError("INTERNAL_SERVER_ERROR", {
              message: chunkCQNPMJJ3_cjs.BASE_ERROR_CODES.FAILED_TO_UPDATE_USER
            });
          }

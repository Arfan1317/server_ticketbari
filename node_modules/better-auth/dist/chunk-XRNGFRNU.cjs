...
var verifyTwoFactorMiddleware = chunkCQNPMJJ3_cjs.createAuthMiddleware(
  {
    body: zod.z.object({
      /**
...
var backupCode2fa = (options) => {
  ...
  return {
    id: "backup_code",
    endpoints: {
      verifyBackupCode: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      generateBackupCodes: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      viewBackupCodes: chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var otp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const send2FaOTP = chunkCQNPMJJ3_cjs.createAuthEndpoint(
    "/two-factor/send-otp",
    {
      method: "POST",
      use: [verifyTwoFactorMiddleware],
  ...
  const verifyOTP = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var totp2fa = (options) => {
  ...
  const twoFactorTable = "twoFactor";
  const generateTOTP = chunkCQNPMJJ3_cjs.createAuthEndpoint(
    "/totp/generate",
    {
      method: "POST",
      use: [chunkCQNPMJJ3_cjs.sessionMiddleware],
  ...
  const getTOTPURI = chunkCQNPMJJ3_cjs.createAuthEndpoint(
  ...
  const verifyTOTP = chunkCQNPMJJ3_cjs.createAuthEndpoint(
...
var twoFactor = (options) => {
  ...
  return {
    ...
    endpoints: {
      ...
      enableTwoFactor: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/two-factor/enable",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          if (!isPasswordValid) {
            throw new betterCall.APIError("BAD_REQUEST", {
              message: chunkCQNPMJJ3_cjs.BASE_ERROR_CODES.INVALID_PASSWORD
            });
          }
      ...
      disableTwoFactor: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/two-factor/disable",
        {
          method: "POST",
          body: zod.z.object({
    ...
    schema: chunkB5UCLTPZ_cjs.mergeSchema(schema, options?.schema),
    rateLimit: [
      {
        pathMatcher(path) {

...
var admin = (options) => {
  ...
  const adminMiddleware = chunkCQNPMJJ3_cjs.createAuthMiddleware(async (ctx) => {
    ...
    if (!user.role || (Array.isArray(opts.adminRole) ? !opts.adminRole.includes(user.role) : user.role !== opts.adminRole)) {
      throw new chunkCQNPMJJ3_cjs.APIError("FORBIDDEN", {
  ...
  return {
      ...
      after: [
        {
          ...
          handler: chunkCQNPMJJ3_cjs.createAuthMiddleware(async (ctx) => {
    ...
    endpoints: {
      setRole: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/set-role",
        {
          method: "POST",
          body: zod.z.object({
      ...
      createUser: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/create-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      listUsers: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/list-users",
        {
          method: "GET",
          use: [adminMiddleware],
      ...
      listUserSessions: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      unbanUser: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/unban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      banUser: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/ban-user",
        {
          method: "POST",
          body: zod.z.object({
      ...
      impersonateUser: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          if (!targetUser) {
            throw new chunkCQNPMJJ3_cjs.APIError("NOT_FOUND", {
          ...
          chunkV6HE2MP7_cjs.deleteSessionCookie(ctx);
      ...
      stopImpersonating: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          await chunkV6HE2MP7_cjs.setSessionCookie(ctx, adminSession);
          return ctx.json(adminSession);
        }
      ),
      revokeUserSession: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      revokeUserSessions: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      removeUser: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/admin/remove-user",
        {
          method: "POST",
          body: zod.z.object({
    ...
    schema: chunkB5UCLTPZ_cjs.mergeSchema(schema, opts.schema)
  };
};
var schema = {
  user: {

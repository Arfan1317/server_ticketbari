...
var genericOAuth = (options) => {
  ...
  return {
    ...
    endpoints: {
      signInWithOAuth2: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/sign-in/oauth2",
        {
          method: "POST",
          body: zod.z.object({
        ...
        async (ctx) => {
          ...
          const authUrl = await chunkV6RGXSG4_cjs.createAuthorizationURL({
            id: providerId,
            options: {
              clientId,
              clientSecret,
      ...
      oAuth2Callback: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        ...
        async (ctx) => {
          ...
          try {
            ...
            tokens = await chunkV6RGXSG4_cjs.validateAuthorizationCode({
              code,

...
var oidcProvider = (options) => {
  ...
  return {
      ...
      after: [
        {
          ...
          handler: async (ctx) => {
            ...
            const parsedSetCookieHeader = chunkV6HE2MP7_cjs.parseSetCookieHeader(
    ...
    endpoints: {
      getOpenIdConfig: chunkCQNPMJJ3_cjs.createAuthEndpoint(
      ...
      oAuth2authorize: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/authorize",
        {
          method: "GET",
      ...
      oAuthConsent: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/consent",
        {
          method: "POST",
          body: zod.z.object({
      ...
      oAuth2token: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/token",
        {
          method: "POST",
          body: zod.z.any(),
      ...
      oAuth2userInfo: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/userinfo",
        {
          method: "GET",
          metadata: {
      ...
      registerOAuthApplication: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/register",
        {
          method: "POST",
          body: zod.z.object({
      ...
      getOAuthClient: chunkCQNPMJJ3_cjs.createAuthEndpoint(
        "/oauth2/client/:id",
        {
          method: "GET",
          use: [chunkCQNPMJJ3_cjs.sessionMiddleware]
